...
class AyudanteProfesor(Alumno, Profesor):
    def __init__(self, nombre, edad, num_cuenta, carrera, num_trabajador, area, num_horas):
        super().__init__(nombre, edad, num_cuenta, carrera)
        Profesor.__init__(self, nombre, edad, num_trabajador, area)
...
def __str__(self):
    return Alumno.__str__(self) + Profesor.__str__(self) + f"Horas trabajadas {self.horas}"

def dar_clase(self, materia):
    print(self.nombre + f" esta dando la clase de: " + materia + f", en el area de: {self.area}")
